...
export default async function ProjectPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    // Herts' OWN business address — never the homeowner's. This used to
    // reuse project.city/state/zip here, which told Google Herts' business
    // was "located" at whatever customer's ZIP code each page happened to
    // be about. areaServed (above) is the right place for the job's location.
    provider: {
